...
Этот каталог содержит активные спецификации legacy-дерева `docs/specs`.
Дублирующие английские функциональные спецификации из `docs/specs/*.md` удалены.

Русские спецификации предназначены для чтения и обслуживания фаундером.
